...
| Badnoob |[Precision AB Drive](./Badnoob/Precision_AB_Drive)|Changes the gearing for the AB drives to improve both resolution and torque, with a strenthened frame. |:grey_question:|:grey_question:|:x:|
| |[Serial Plate](./Badnoob/Serial_Plate) |Modified skirt piece to display your serial number|:grey_question:|:grey_question:|:x:|
| |[Rail Alignment](./Badnoob/Rail_Alignment)|Tools and procedure to properly align the rails |:grey_question:|:grey_question:|:grey_question:|
